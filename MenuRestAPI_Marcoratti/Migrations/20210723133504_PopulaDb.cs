...
namespace MenuRestAPI_Marcoratti.Migrations
{
    public partial class PopulaDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("Insert into Categorias(name,imageUrl) values('Sobremesas','http://google.com/images/3.jpg')");

            migrationBuilder.Sql("Insert into produtos(name,description,price,imageUrl,amount,created_at,category_id) " +
                "values('Suco Dell Vale','Suco natural 250ml',5.50,'http://google.com/images2/6.jpg',20,now(),(Select id from categorias where name='Bebidas'))");
